...
### `sendSoundPlay(player, name, path, entity, soundCategory, distOrRoll, pitch, keepTime){:java}`
- 绑定到指定实体播放具名音效
...
### `sendSoundPlay(player, path, entity, soundCategory, distOrRoll, pitch, keepTime){:java}`
- 绑定到指定实体播放无名音效
...
### `sendSoundPlay(player, name, path, soundCategory, distOrRoll, pitch, keepTime){:java}`
- 绑定到玩家自身播放具名音效
...
### `sendSoundPlay(player, path, soundCategory, distOrRoll, pitch, keepTime){:java}`
- 绑定到玩家自身播放无名音效
