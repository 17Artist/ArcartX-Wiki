...
<Callout type="info">
需要服务器安装 [PlaceholderAPI](https://www.spigotmc.org/resources/placeholderapi.6245/) 插件，Chronos 会在启动时自动注册扩展。
</Callout>
